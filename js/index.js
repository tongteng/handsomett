$( document ).ready(function() {  
    ...
    function ParticleAnimation(){
        ...
        for(var i = 0; i < particles.length; i++)
        {
            ...
            // ½¥±äµÄÍ¸Ã÷¶ÈÔ½À´Ô½Í¸Ã÷(ÒâË¼ÊÇ»ðÑæÏòÉÏµÄ¹ý³ÌÖÐ±ä°µ)
            ...
            // ½¥±äµÄyÖáÔÚ¼õÐ¡(»ðÑæÏòÉÏ,¿ÉÒÔµ÷ÕûÆäÖµÀ´¸Ä±ä»ðÑæµÄ·½Ïò)
